...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-4 col-md-4 col-sm-12">
                <div class="thumbnail">
                    <a href="#" onclick="afficherImage('image1')">
                        <img id="image1" src="Images/fruit1.jpg" alt="Image 1" style="width:100%">
                        <div class="caption">
            ...
            <div class="col-lg-4 col-md-4 col-sm-12">
                <div class="thumbnail">
                    <a href="#" onclick="afficherImage('image2')">
                        <img id="image2" src="Images/fruit2.jpg" alt="Image 2" style="width:100%">
                        <div class="caption">
            ...
            <div class="col-lg-4 col-md-4 col-sm-12">
                <div class="thumbnail">
                    <a href="#" onclick="afficherImage('image3')">
                        <img id="image3" src="Images/fruit3.jpg" alt="Image 3" style="width:100%">
                        <div class="caption">
            ...
            <div class="col-lg-4 col-md-4 col-sm-12">
                <div class="thumbnail">
                    <a href="#" onclick="afficherImage('image4')">
                        <img id="image4" src="Images/legume1.jpg" alt="Image 4" style="width:100%">
                        <div class="caption">
            ...
            <div class="col-lg-4 col-md-4 col-sm-12">
                <div class="thumbnail">
                    <a href="#" onclick="afficherImage('image5')">
                        <img id="image5" src="Images/legume2.jpg" alt="Image 5" style="width:100%">
                        <div class="caption">
            ...
            <div class="col-lg-4 col-md-4 col-sm-12">
                <div class="thumbnail">
                    <a href="#" onclick="afficherImage('image6')">
                        <img id="image6" src="Images/legume3.jpg" alt="Image 6" style="width:100%">
                        <div class="caption">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-body text-center">
                    <img id="modalImage" src="" alt="Image agrandie" style="max-width: 100%; max-height: 100vh;">
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        function afficherImage(imageId) {
            var imageUrl = document.getElementById(imageId).getAttribute('src');
