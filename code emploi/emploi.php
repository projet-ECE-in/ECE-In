...
<body>
    <header class="page-header header container-fluid">
        ...
        <img id="logo" src="../mess/image_mess/Logo_ECEIn.png" alt="Logo">
    ...
    <div class="wrapper">
        <div class="navbar">
            <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                ...
                <div class="spass"></div>
                <div class="spass"></div>
                <a href="../code reseau/reseau.php"><div class="image-container"><img src="../mess/image_mess/loupe.png" alt="loupe" height="95%" width="100%"></div><div class="item-nav"></div></a>
                <div class="spass"></div>
                <div class="spass"></div>
                ...
                <div class="spass"></div>
                <div class="spass"></div>
                <a href="#"><div class="image-container"><img src="../mess/image_mess/empoie.png" alt="notif" height="95%" width="100%"></div><div class="cercle"></div></a>
            </div>
        </div>
