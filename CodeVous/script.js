...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.getElementById('generate-cv').addEventListener('click', () => {
        // Ouvrir une fenêtre de sélection de fichier uniquement si le clic provient du bouton d'importation XML
        const isImportButton = document.activeElement.id === 'import-xml';
        if (isImportButton) {
